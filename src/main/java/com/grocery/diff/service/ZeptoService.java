...
public class ZeptoService {
    ...
    public void getProduct(ZeptoRequest zeptoRequest) {
        HttpEntity<Object> request = getObjectHttpEntity(zeptoRequest);

        ResponseEntity<ZeptoResponse> response = restTemplate.exchange(zeptoUrl,
                HttpMethod.POST, request, ZeptoResponse.class);
