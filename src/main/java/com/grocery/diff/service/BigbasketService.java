...
//TODO pagination
        return restTemplate.exchange(String.format("%s%s%s", bigBasketUrl, "?type=deck&page=20&slug=", query),
                HttpMethod.GET, request, BigBasketResponse.class);
    }

    private HttpEntity<Object> getObjectHttpEntity() throws IOException {
